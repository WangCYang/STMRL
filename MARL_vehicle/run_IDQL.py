...
if __name__ == "__main__":
    ...
    for i in Edge_IDs:
        ...
        rl_agent = RL_agent_DDQN(num_car_max*3 + num_car_max* 3 + 2 + 1 + len(edge_i.neighboring_edges)*3,  # state： 自身状态（任务信息，车辆信息，边缘服务器信息，流量预测） + 邻居节点的状态(任务总量, 算力，预测)
                                 ...
                                 learning_rate, batch_size, "{}/v1_IDQL_hidden_{}_bs_{}_epoch_{}".format(Simulation_scenario,num_hidden_nodes1,batch_size,epoches),i)          # new an agent
    ...
    saved_avg_data = "saved_data/{}/MARL_IDQL_training_{}_v1_hidden_{}_bs_{}_epoch_{}.pkl".format(Simulation_scenario, Time_range, num_hidden_nodes1, batch_size, epoches)
    ...
    saved_fig_file = "figv0/{}/{}_IDQL_{}.png".format(Simulation_scenario, flag, Time_range)
