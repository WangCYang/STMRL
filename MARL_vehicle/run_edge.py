...
if __name__ == "__main__":
    ...
    for epd in range(start_epi, start_epi + episode):
        ...
        while True:
            ...
            for i in Edge_IDs:
                actions[i] = int(math.pow(2, e.edges[i].car_max)) - 1
        ...
        # print(all_task_num)
        print('total latency, %.4f, average latency per time, %.4f, average latency per task: %.4f ,average wait latency per task: %.4f'% (all_latency, aver_latency, all_latency/all_task_num, all_wait_latency/all_task_num))
    ...
    saved_avr_laten_file = "saved_data/{}/Edge_test_range_{}_{}.pkl".format(Simulation_scenario, start_epi,
                                                                             start_epi + episode)
    ...
    saved_fig_file = "figv0/{}/{}_Edge_range_{}_{}.png".format(Simulation_scenario, flag, start_epi,
                                                                start_epi + episode)
