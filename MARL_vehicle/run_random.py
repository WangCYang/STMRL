...
if __name__ == "__main__":
    ...
    for epd in range(start_epi, start_epi + episode):
        ...
        while True:
            ...
            for i in Edge_IDs:
                ...
                #     car_num_i = len(e.edges[i].connected_vehicles)
                # else:
                #     car_num_i = e.edges[i].car_max
                car_num_i = len(e.edges[i].connected_vehicles)
                actions[i] = np.random.randint(low= 0,high=int(math.pow(2, car_num_i)),size=1)[0]
    ...
    saved_avr_laten_file = "saved_data/{}/Random_test_range_{}_{}.pkl".format(Simulation_scenario, start_epi,
                                                                             start_epi + episode)
    ...
    saved_fig_file = "figv0/{}/{}_Random_range_{}_{}.png".format(Simulation_scenario, flag, start_epi,
                                                                start_epi + episode)
