...
if __name__ == "__main__":
    ...
    batch_size = 64            # batch size of sampling   # 每次采样512个经验样本
    ...
    Edge_neighbors = load_neighbor_edges("../sumo/data/{}/global_neighbor_edges.pkl".format(Simulation_scenario))
    ...
    # RL_based Agents
    Multi_Agents = {}
    restore_dir = "models_DDQN/{}/v1_hidden_128_bs_64_epoch_1".format(Simulation_scenario)
    for i in Edge_IDs:
        edge_i = e.edges[i]
    ...
    saved_avr_laten_file = "saved_data/{}/MARL_test_MADDQN_GlobalNeighbor_range_{}_{}.pkl".format(Simulation_scenario,start_epi,start_epi+episode)
    ...
    saved_fig_file = "figv0/{}/{}_STMARL_GlobalNeighbor_range_{}_{}.png".format(Simulation_scenario,flag, start_epi,start_epi+episode)
