...
if __name__ == "__main__":
    ...
    Edge_neighbors = load_neighbor_edges("../sumo/data/{}/no_neighbor_edges.pkl".format(Simulation_scenario))
    ...
    saved_avr_laten_file = "saved_data/{}/MARL_test_MADDQN_NONeighbor_range_{}_{}.pkl".format(Simulation_scenario,start_epi,start_epi+episode)
    ...
    saved_fig_file = "figv0/{}/{}_STMARL_NONeighbor_range_{}_{}.png".format(Simulation_scenario,flag, start_epi,start_epi+episode)
