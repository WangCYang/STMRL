...
if __name__ == "__main__":
    ...
    saved_avr_laten_file = "saved_data/{}/MARL_test_IDQL_range_{}_{}.pkl".format(Simulation_scenario,start_epi,start_epi+episode)
    ...
    saved_fig_file = "figv0/{}/{}_IDQL_range_{}_{}.png".format(Simulation_scenario,flag, start_epi,start_epi+episode)
